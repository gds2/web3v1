...
describe("Start all the tests", function () {
    ...
    describe("Test#8 Post an empty body to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send({}).set('Accept', /application\/json/).set('Authorization', token).expect(400, done);
        });
    });

    describe("Test#9 Post a wrong type of body to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send(",,,,,,,,,,,}").set('Authorization', token).expect(400, done);
        });
    });

    describe("Test#10 Get users by using a letter instead of a number by paging", function () {
        it("Should return a json file and a 200 code", function (done) {
            server.get("api/users/page/a").expect("Content-type", /json/).set('Authorization', token).expect(200, done);
        });
    });

    describe("Test#11 Try getting users from a page that doesnt have any users", function () {
    ...
    describe("Test#12 Post a body without a password to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send({
                "name": "test",
                "lastname": "tester",
    ...
    describe("Test#13 Post a body without an username to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send({
                "name": "test",
                "lastname": "tester",
    ...
    describe("Test#14 Post a body without a first name to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send({
                "lastname": "tester",
                "preposition": "de",
    ...
    describe("Test#15 Post a body without a last name to the users", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/users").send({
                "name": "test",
                "preposition": "de",
    ...
    describe("Test#16 Post a full body to the ratings/update rating", function () {
    ...
    describe("Test#17 Get a rating  for a movie the user rated before", function () {
        it("Should return a 200 code", function (done) {
     ...
     */
    describe("Test#21 Post a full body to the ratings without a token", function () {
        it("Should return a 401 code", function (done) {
            server.post("api/ratings").send({
                "rating": 5,
                "imdb": "126"
    ...
    describe("Test#22 Get a rating  for a movie the user hasnt rated before", function () {
        it("Should return a 200 code", function (done) {
            server.get("api/ratings/123030030454050405").set('Accept', /application\/json/).set('Authorization', token).expect(404, done);
        });
    });

    describe("Test#23 Post a rating to a movie that doesnt exist", function () {
        it("Should return a 404 code", function (done) {
            server.post("api/ratings").send({
                "rating": 5,
    ...
    describe("Test#24 Post a rating that doesnt have an imdb", function () {
        it("Should return a 404 code", function (done) {
            server.post("api/ratings").send({
                "rating": 5
            }).set('Accept', /application\/json/).set('Authorization', token).expect(404, done);
    ...
    describe("Test#25 Post a rating that doesnt have a rating amount", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/ratings").send({
                "imdb": "123"
    ...
    describe("Test#26 Post a wrong json format to the ratings", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/ratings").set('Authorization', token).send(",,,,fds,fsf,sfsjkl;:::").set('Accept', /application\/json/).expect(400, done);
        });
    });

    describe("Test#27 Post an empty json  to the ratings", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/ratings").set('Authorization', token).send({}).set('Accept', /application\/json/).expect(400, done);
        });
    });

    describe("Test#28 get a list of average ratings without a token", function () {
        it("Should return a 401 code", function (done) {
            server.get("api/ratings/average").expect(401, done);
        });
    });

    describe("Test#29 try getting a list of average ratings by using a page that doenst exist", function () {
        it("Should return a 404 code", function (done) {
    ...
    describe("Test#30 try getting a list of average ratings by using a letter instead of a number at paging", function () {
        it("Should return a 200 code", function (done) {
            server.get("api/ratings/average/page/sdadadada").set('Authorization', token).expect("Content-type", /json/).expect(200, done);
        });
    });

    describe("Test#31 Delete a rating without a token", function () {
        it("Should return a 401 code", function (done) {
            server.delete("api/ratings/123").expect(401, done);
        });
    });

    describe("Test#32 Delete a rating that doesnt exist", function () {
        it("Should return a 404 code", function (done) {
    ...
    describe("Test#33 Post a rating with the rating amount not being a number ", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/ratings").send({
                "rating": "5",
                "imdb": "123"
    ...
    describe("Test#34 Post a rating with the rating amount being lower than 0.5 ", function () {
        it("Should return a 400 code", function (done) {
            server.post("api/ratings").send({
                "rating": 0.4,
                "imdb": "123"
    ...
    describe("Test#35 Post a rating with the rating amount being higher than 5 ", function () {
        it("Should return a 200 code", function (done) {
            server.post("api/ratings").send({
                "rating": 6,
                "imdb": "123"
     ...
     */
    describe("Test#36 Try getting the movies", function () {
        it("Should return a json file and a 200 code", function (done) {
            server.get("api/movies").expect("Content-type", /json/).set('Authorization', token).expect(200, done);
        });
    });

    describe("Test#37 Try getting the movies by using paging", function () {
        it("Should return a json file and a 200 code", function (done) {
            server.get("api/movies/page/1").expect("Content-type", /json/).set('Authorization', token).expect(200, done);
        });
    });

    describe("Test#38 Try getting the movies by using certain parameters in the url", function () {
        it("Should return a json file and a 200 code", function (done) {
     ...
     */
    describe("Test#39 Try getting the movies without a token", function () {
        it("Should return a 401 error Invalid token", function (done) {
            server.get("api/movies").expect(401, done);
        });
    });

    describe("Test#40 Try getting the movies by using a page that doesnt have any data", function () {
    ...
    describe("Test#41 Try getting the movies by using a letter as a  page number", function () {
        it("Should return a json file and a 200 code", function (done) {
            server.get("api/movies/page/a").set('Authorization', token).expect("Content-type", /json/).expect(200, done);
        });
    });

    describe("Test#42 Try getting a movie that doest have the parameters in the url", function () {
        it("Should return a json file and a 404 code", function (done) {
